...
흩어진 글을 한 곳에 모아 균형 있게 다시 찾는 local-first 아카이브입니다. 사용자 데이터는 서버에 저장하지 않고 각 브라우저의 IndexedDB에 저장합니다.
...
- JSON 내보내기/가져오기, 기존 백업 JSON 마이그레이션
...
키가 없어도 앱은 동작하며 태그 제안은 조용히 fallback 됩니다.
